                                    ...
                                    <div className="table-group-outer table-group-market">
                                        ...
                                        <div className="table-group-head px-3 d-flex justify-content-space-between">
                                            <div className="table-group-tr">
                                                ...
                                                <div className="table-group-td text-uppercase  mr-11" style={{ color: "white" }}>BNB</div>
                                                ...
                                                <div className="table-group-td text-end ml-10" style={{ color: "white" }}>
                                                <a href='https://www.bnbchain.org/en/testnet-faucet' target='blank' style={{textDecoration: 'none'}}><Button className='w-70 btn-grad'>Claim</Button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
