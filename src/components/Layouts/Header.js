...
import {calltokenForUsers, connectWalletLaunchpad} from '../apicallfunction';
...
//get end
      ...
      const getUserGeolocationDetails = (addr) => {
        //console.log("INN")
          fetch(
    ...
    //console.log("avalue",a)
      ...
      //console.log("avalue",a)
        ...
        //for decoding escrow address
         ...
         //get three assets
         let accountInfoResponse = await algodClient.accountInformation(b).do();
                    ...
                    <Container fluid="lg">
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            ...
                            <div className="navbar-controls order-xl-2 d-flex align-items-center">
                                ...
                                { showButton ? 
                                isConnected ? 
                                <>{chainId === 97 ? <button className='btn me-0 btn-grad' onClick={()=>connectWalletSei()}>{ address? <>{(address).substring(0, 4)}...{(address).substring((address).length -4, (address).length)}</> :" Connect Wallet"}</button> : 
                                ...
                                <Dropdown >
                                    ...
                                    <Dropdown.Menu className="dropdown-menu-end dropdown-menu-setting p-3">
                                        <div className="dropdown-menu-header mb-3">
                                            ...
                                            <Col>
                                            <button className='btn btn-grad'> <center> {parseFloat(wb).toFixed(2)} ETH <br/>(TestNet) </center></button> 
                                            </Col>
                                            </Row>
                                        </div>
                                        ...
                                        <Link to="#" className="d-flex py-1 align-items-center">
                                                    ...
                                                    <span className='ms-3 flex-grow-1 d-flex justify-content-between'>
                                                        <div>
                                                            <h6 className='m-0'>ETH</h6><small></small>
                            ...
                            <Nav className="mx-auto navbar-nav-inner">
                                ...
                                <Dropdown>
                                        ...
                                        <a className='nav-link inactive'>Money Market</a>
                                        </Dropdown.Toggle>
                        ...
                        {aidvalues===null || aidvalues ==="" || aidvalues ===undefined || aidvalues.length == 0?(<>
                         ...
                         <div className="table-group-body">
                             <div className="table-group-tr">
                                ...
                                <div className="table-group-td" >{r.assetName}</div>
