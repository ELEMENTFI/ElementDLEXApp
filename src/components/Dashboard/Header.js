...
import {Container, Navbar, Nav, Badge, Dropdown, Row, Col} from 'react-bootstrap';
import {
    NavLink as Link
...
function Header() {
    ...
    const connectWallet = async () => {
      ...
      {
        const accountInfo = await algodClient.accountInformation(localStorage.getItem("walletAddress")).do();
        console.log(accountInfo);
        setAssetCount(accountInfo['assets']['length']);
                ...
                <Navbar expand="xl" className='p-0'>
                    <Container fluid="lg">
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                                ...
                                <Dropdown >
                                    ...
                                    <Dropdown.Menu className="dropdown-menu-end dropdown-menu-setting p-3">
                                        <div className="dropdown-menu-header mb-3">
                                            ...
                                            <Col>
                                            <button className='btn btn-grad'> <center> {(parseFloat(algoBalance)/1000000).toFixed(2)} ETH <br/>(TestNet) </center></button> 
                                            </Col>
                                            </Row>
                                        </div>
                            ...
                            <div className="social-icons mt-5 justify-content-center d-flex d-xl-none align-items-center">
